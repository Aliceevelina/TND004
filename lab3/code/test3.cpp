...
#ifdef TEST_ITERATOR
    {
        std::ifstream file{"/Users/Alice/Desktop/SKOLA/TND004 - Datastrukturer/lab3/code/words.txt"};
...
//        std::cout << '\n';
        ...
        file.open("/Users/Alice/Desktop/SKOLA/TND004 - Datastrukturer/lab3/code/inorder_traversal.txt");
...
//            // Inorder traversal
//            for (BinarySearchTree<std::string>::Iterator it = t.begin(); it != t.end(); ++it) {
//                 V1.push_back(*it);
//             }
